...
1. Open the project folder `8.ProjectCode` in File Explorer.
...
afterwards. See [05_MODELS_AND_TRAINING.md](05_MODELS_AND_TRAINING.md).
...
See [09_TESTING.md](09_TESTING.md). If something does not work, see
